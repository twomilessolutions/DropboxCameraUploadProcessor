...
* **CameraUploadsConfig.py**: This file reads/creates a config file then asks the user where the Dropbox Camera Uplods folder is.
...
© 2021-2022 [Two Miles Solutions](https://www.twomilessolutions.com), All Rights Reserved.